...
public class CategoryEat extends AppCompatActivity {
    private static final String TAG = "CategoryEat";
    private Users user;
    private RecyclerView eatRV;
    private PageAdapterEat eatAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.category_eat);

        Folder = FirebaseStorage.getInstance().getReference().child("AttractivePlaces");
        eatRV = findViewById(R.id.eatListView);
        ...
        eatRV.setLayoutManager(new LinearLayoutManager(this));
        eatAdapter = new PageAdapterEat(placesArrayList, getApplicationContext(), fStore);
        ...
        fListener = fStore.collection("attractivePlaces")
                ...
                .whereEqualTo("category", "Category Eat")
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(CategoryEat.this, AddNewPlace.class));
                finish();
            }
        });
    ...
    private void loadLogList() {
                ...
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            eatRV.setLayoutManager(mLayoutManager);
                            eatRV.setItemAnimator(new DefaultItemAnimator());
                            eatRV.setAdapter(eatAdapter);
                        } else {
        ...
        fStore.collection("users")
                .document(userID)
                .addSnapshotListener(CategoryEat.this, new EventListener<DocumentSnapshot>() {
                    @Override
    ...
    private void filter(String text) {
        ...
        if (filteredList.isEmpty()) {
            ...
            eatAdapter.filterList(filteredList);
        }
    }
