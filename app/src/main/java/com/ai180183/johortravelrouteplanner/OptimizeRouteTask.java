...
public class OptimizeRouteTask extends AsyncTask<Void, Void, Void> {
    ...
    private ArrayList<List<JSONParser.PlaceDetails>> mLocations = new ArrayList<>();
    private long[][][][] dist =
    ...
    protected Void doInBackground(Void... params) {
        for (int i=0; i<mSize; i++) {
            JSONParser.PlaceDetails placeDetails = mActivity.mDirectionsPlaceDetails.get(i);
        ...
        try {
            for (int i=0; i<mSize; i++) {
                ...
                if (placeDetails != null && placeDetails.getPlaceId() != null) {
                    ...
                    ArrayList<JSONParser.PlaceDetails> locations = new ArrayList<>();
                    for (int j=0; j<mCenters.size(); j++) {
                        ArrayList<JSONParser.PlaceDetails> locationsInfo = JSONParser.nearbySearch(
    ...
    private void bitmask_DP_BFS() throws Exception {
        ...
        ArrayList<JSONParser.PlaceDetails> chosenLocations = new ArrayList<>();
