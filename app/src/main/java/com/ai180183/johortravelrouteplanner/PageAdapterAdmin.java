...
public class PageAdapterAdmin extends RecyclerView.Adapter<PageAdapterAdmin.ViewHolder> {
    private static final String TAG = "PageAdapterAdmin";
    ...
    public PageAdapterAdmin(ArrayList<Users> userList, Context context, FirebaseFirestore fStore) {
    ...
    @NonNull
    @Override
    public PageAdapterAdmin.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.change_admin,parent,false);

        return new PageAdapterAdmin.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull PageAdapterAdmin.ViewHolder holder, final int position) {
        ...
        holder.upgradeUser.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                userAdd.setUser(true);
                Log.d(TAG, "Here: "+userAdd.getFullName()+" and "+userAdd.getUserId());
                AlertDialog.Builder alertDialog = new AlertDialog.Builder(view.getContext());
                alertDialog.setTitle("Are you sure to change this admin to user?");
        ...
        fStore.collection("users").document(userID)
                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        Toast.makeText(context, "User type of is changed.",Toast.LENGTH_SHORT).show();
                    }
