...
public class ChangeUsers extends AppCompatActivity {
    private static final String TAG = "ChangeUsers";
    private RecyclerView userRV;
    private PageAdapterUsers userAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userAdapter = new PageAdapterUsers(userArrayList, getApplicationContext(), fStore);
