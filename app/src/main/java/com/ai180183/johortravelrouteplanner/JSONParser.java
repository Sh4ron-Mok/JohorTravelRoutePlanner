...
import static com.ai180183.johortravelrouteplanner.MapsActivity.LAT;
import static com.ai180183.johortravelrouteplanner.MapsActivity.LNG;
import static com.ai180183.johortravelrouteplanner.OptimizeRouteTask.RESULTS_RETURNED;
...
public class JSONParser {
    ...
    public static Pair<Boolean, ArrayList<Pair<String, String>>> placeAutocomplete(int position,
        ...
        Log.d(TAG,"AutoComplete: "+jsonObject);
    ...
    public static Pair<Boolean, PlaceDetails> placeDetails(String placeId, String key,
        ...
        if (placeId != null) {
            ...
            Log.d(TAG,"PlaceDetails: "+jsonObject);
    ...
    public static ArrayList<PlaceDetails> nearbySearch(
        ...
        Log.d(TAG,"NearbySearch "+jsonObject);
    ...
    public static long[][] distanceMatrix(String origins, String destinations, Activity mActivity)
        ...
        Log.d(TAG,"DistanceMatrix "+jsonObject);
    ...
    public static ArrayList<ArrayList<HashMap<String, String>>> directions(
        ...
        Log.d(TAG,"Directions: "+jsonObject);
