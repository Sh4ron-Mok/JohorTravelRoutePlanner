...
public class CategoryPlay extends AppCompatActivity {
    private static final String TAG = "CategoryPlay";
    private RecyclerView playRV;
    private PageAdapterEat playAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.category_play);

        Folder = FirebaseStorage.getInstance().getReference().child("AttractivePlaces");
        playRV = findViewById(R.id.playListView);
        ...
        playRV.setHasFixedSize(true);
        playRV.setLayoutManager(new LinearLayoutManager(this));
        playAdapter = new PageAdapterEat(placesArrayList, getApplicationContext(), fStore);
        ...
        fListener = fStore.collection("attractivePlaces")
                ...
                .whereEqualTo("category", "Category Play")
        ...
        if (!userEmail.equals("huifenmok@gmail.com")) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(CategoryPlay.this, AddNewPlace.class));
                finish();
            }
        });
    ...
    private void loadLogList() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            for (DocumentSnapshot doc : task.getResult()) {
                                ...
                                places.setPlaceImg(doc.getString("placeImg"));
                                placesArrayList.add(places);
                            }

                            playAdapter = new PageAdapterEat(placesArrayList, getApplicationContext(), fStore);
                            RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(getApplicationContext());
                            playRV.setLayoutManager(mLayoutManager);
                            playRV.setItemAnimator(new DefaultItemAnimator());
                            playRV.setAdapter(playAdapter);
                        } else {
        ...
        fStore.collection("users")
                .document(userID)
                .addSnapshotListener(CategoryPlay.this, new EventListener<DocumentSnapshot>() {
                    @Override
    ...
    private void filter(String text) {
        ...
        if (filteredList.isEmpty()) {
            ...
            playAdapter.filterList(filteredList);
        }
    }
