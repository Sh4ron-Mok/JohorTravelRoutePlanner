...
import com.ai180183.johortravelrouteplanner.SearchHistoryContract.SearchHistoryEntry;
...
public class FragmentAdd extends Fragment implements SearchView.OnQueryTextListener, View.OnFocusChangeListener {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mSearchResultsHeader.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mSearchResultsExpanded) {
                    ...
                    mSearchResultsExpandBtn.setImageResource(R.drawable.ic_baseline_expand_more_24);
                    mSearchResultsAdapter.expandLess();
                } else {
                    mSearchResultsExpanded = true;
                    mSearchResultsExpandBtn.setImageResource(R.drawable.ic_baseline_expand_less_24);
        ...
        mSearchHistoryHeader.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mSearchHistoryExpanded) {
                    ...
                    mSearchHistoryExpandBtn.setImageResource(R.drawable.ic_baseline_expand_more_24);
                    mSearchHistoryAdapter.expandLess();
                } else {
                    mSearchHistoryExpanded = true;
                    mSearchHistoryExpandBtn.setImageResource(R.drawable.ic_baseline_expand_less_24);
        ...
        backBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mActivity.mapFragment.getView().setAlpha(1f);
                ...
                mActivity.mBottomNavigationViewState = R.id.explore;
            }
        });
    ...
    public boolean onQueryTextChange(final String s) {
        if (s.length() == 0) {
            mMicOrCloseBtn.setImageResource(R.drawable.ic_baseline_mic_24);
        } else {
            mMicOrCloseBtn.setImageResource(R.drawable.ic_baseline_clear_all_24);
        }
    ...
    public static class GetPlaceDetailsTask extends AsyncTask<String, Void, Pair<JSONParser.PlaceDetails, String>> {

        @Override
        protected Pair<JSONParser.PlaceDetails, String> doInBackground(String... placeId) {
            if (placeId[0] != null && placeId[0].equals(CURRENT_LOCATION)) {
                return new Pair<>(new JSONParser.PlaceDetails(), placeId[1]);
            }
            ...
            try {
                ...
                Pair<Boolean, JSONParser.PlaceDetails> placeDetails = JSONParser.placeDetails(placeId[0],
        ...
        @Override
        protected void onPostExecute(Pair<JSONParser.PlaceDetails, String> placeDetailsQuery) {
            JSONParser.PlaceDetails placeDetails = placeDetailsQuery.first;
            ...
            if (mActivity.mAddPosition != -1) {
                ...
                if (placeDetails.getLatLng().first != null
                    ...
                    mActivity.mComposeMarkers.add(mActivity.mAddPosition,
                            mActivity.googleMap.addMarker(new MarkerOptions()
                                    .position(new LatLng(
